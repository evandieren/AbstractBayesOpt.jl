...
function test_bayesian_optimization()
    ...
    # Run optimization
    result, acq_list,
    standard_params = AbstractBayesOpt.optimize(bo_struct; standardize = nothing)
...
function test_gradient_optimization()
    ...
    # Run optimization
    result_grad, acq_list_grad,
    standard_params_grad = AbstractBayesOpt.optimize(bo_struct_grad)
